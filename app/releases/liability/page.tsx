      ...
      <div className="relative flex flex-col w-full min-h-dvl items-center p-24 text-black">
        ...
        >
          ...
          <p>
            ...
            experiencing injuries while engaging in any activity. In the event
            of any injury or illness to me during my participation, I authorize
            the staff of Pop-Up Hanami or the security team to seek and obtain
            such emergency or medical services as may be deemed necessary at the
            time, but understand and agree that they shall not be obligated to
            do so.
          </p>
          <p>
            I further acknowledge that I may be subject to being filmed or
            photographed at any time during the Event and hereby release the UBC
            Anime Club, Pop-Up Hanami and its legal representatives for all
            claims and liability relating to said images or video. Furthermore,
            I grant permission to the above-mentioned parties the right to use
            photographs and/or video images taken of me, or members of my
            family, for the purpose of publication, promotion and advertising,
            in any manner or in any medium.
          </p>
          ...
          <p>Final Notice:</p>
          <p>
            By entering the premises of this event and purchasing access I have
            read the above statements and hereby forfeit all right to bring a
            suit against the UBC Anime Club and any persons affiliated with
            Pop-Up Hanami for any reason. In return, I will receive the right to
            participate as an attendee in this Event. I will also make an effort
            to obey every safety precaution listed either in writing or
