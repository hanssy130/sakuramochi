...
export function NavBar() {
  ...
  return (
    <header className="font-sans sticky top-4 inset-x-0 flex flex-wrap md:justify-between md:flex-nowrap z-50 w-full text-sm">
      <motion.nav
        className="relative max-w-[90rem] w-full bg-white text-lg tracking-wider uppercase font-bold border-2 border-grey md:rounded-full rounded-[30px] mx-2 py-3 px-4 md:flex md:items-center justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto"
        aria-label="Global"
